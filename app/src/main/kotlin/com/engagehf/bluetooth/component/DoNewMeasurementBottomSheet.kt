...
fun DoNewMeasurementBottomSheet() {
    Column(
        ...
        Row {
            ...
            Icon(
                painter = painterResource(id = com.engagehf.modules.design.R.drawable.ic_blood_pressure),
            ...
            Icon(
                painter = painterResource(id = com.engagehf.modules.design.R.drawable.ic_monitor_weight),
