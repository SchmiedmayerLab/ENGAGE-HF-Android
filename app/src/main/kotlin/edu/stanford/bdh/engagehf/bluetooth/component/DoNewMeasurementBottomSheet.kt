...
fun DoNewMeasurementBottomSheet() {
    Column(
        ...
        Row {
            ...
            Icon(
                painter = painterResource(id = edu.stanford.bdh.engagehf.modules.design.R.drawable.ic_blood_pressure),
            ...
            Icon(
                painter = painterResource(id = edu.stanford.bdh.engagehf.modules.design.R.drawable.ic_monitor_weight),
