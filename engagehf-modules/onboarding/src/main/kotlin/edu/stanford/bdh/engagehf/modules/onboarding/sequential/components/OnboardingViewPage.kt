...
package edu.stanford.bdh.engagehf.modules.onboarding.sequential.components
 ...
 * @sample edu.stanford.bdh.engagehf.modules.onboarding.sequential.SequentialOnboardingScreen
 */
@Composable
...
fun OnboardingViewPagePreview() {
    OnboardingViewPage(
        ...
        iconId = edu.stanford.bdh.engagehf.modules.design.R.drawable.ic_groups,
    )
}
