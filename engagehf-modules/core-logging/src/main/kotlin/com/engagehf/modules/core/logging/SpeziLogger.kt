...
class SpeziLogger internal constructor(private val tag: String, private val config: LoggerConfig) {
    ...
    companion object {
        ...
        /**
         * Logs an informational message with tag `com.engagehf.modules.logger` using [LoggingStrategy.TIMBER].
         *
         * @param throwable Optional throwable associated with the message.
         * @param message A function providing the message to be logged.
         */
        ...
        /**
         * Logs a warning message with tag `com.engagehf.modules.logger` using [LoggingStrategy.TIMBER].
         *
         * @param throwable Optional throwable associated with the message.
         * @param message A function providing the message to be logged.
         */
        ...
        /**
         * Logs an error message with tag `com.engagehf.modules.logger` using [LoggingStrategy.TIMBER].
         *
         * @param throwable Optional throwable associated with the message.
         * @param message A function providing the message to be logged.
         */
